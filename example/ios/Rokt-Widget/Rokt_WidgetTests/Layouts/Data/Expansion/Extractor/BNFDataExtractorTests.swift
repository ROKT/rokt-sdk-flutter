...
final class BNFDataExtractorTests: XCTestCase {
    ...
    func test_extractDataRepresentedBy_usingValidCreativeCopyPropertyChain_returnsNestedString() {
        XCTAssertEqual(
            sut?.extractDataRepresentedBy(String.self, propertyChain: "DATA.creativeCopy.creative.termsAndConditions.link", responseKey: nil, from: offer),
    ...
    func test_extractDataRepresentedBy_usingValidCreativeResponsePropertyChain_returnsNestedString() {
        XCTAssertEqual(
            sut?.extractDataRepresentedBy(String.self, propertyChain: "DATA.creativeResponse.shortSuccessLabel", responseKey: "positive", from: offer),
    ...
    func test_extractDataRepresentedBy_usingInvalidPropertyChain_returnsNestedString() {
        XCTAssertEqual(
            sut?.extractDataRepresentedBy(String.self, propertyChain: "DATA.creative.missingTestId", responseKey: nil, from: offer),
    ...
    func test_extractDataRepresentedBy_usingValidCreativeLinkPropertyChain_returnsNestedString() {
        XCTAssertEqual(
            sut?.extractDataRepresentedBy(String.self, propertyChain: "DATA.creativeLink.privacyPolicy", responseKey: nil, from: offer),
