...
class TestTransformer: XCTestCase {
    ...
    func test_offer_without_title() throws {
        ...
        XCTAssertEqual(try transformer.transferOfferContentText(slot: slot), "Content")
    }
    ...
    func test_offer_without_title_and_content() throws {
        ...
        let transformer = getPlacementTransformer(placement)
        XCTAssertThrowsError( try transformer.transferOfferContentText(slot: slot)) { error in
            XCTAssertEqual(error as! TransformerError,
    ...
    func test_offer_with_title_with_default_configuration() throws {
        ...
        XCTAssertEqual(try transformer.transferOfferContentText(slot: slot), "Title Content")
    }
    ...
    func test_offer_with_title_inline() throws {
        let configurables = [MobileCreativeInLineCopyWithHeading: "true"]
        let placement = getSamplePlacement(configurables)
        let slot = Slot(instanceGuid: "",
                        offer: Offer(campaignId: "",
                                     creative:
    ...
    func test_offer_with_title_next_line() throws {
        let configurables = [MobileCreativeInLineCopyWithHeading: "false"]
        let placement = getSamplePlacement(configurables)
        let slot = Slot(instanceGuid: "",
                        offer: Offer(campaignId: "",
                                     creative:
        ...
        XCTAssertEqual(try transformer.transferOfferContentText(slot: slot), "Title.</br>Content")
    }
    ...
    func test_offer_with_title_inline_with_two_dots() throws {
        ...
        XCTAssertEqual(try transformer.transferOfferContentText(slot: slot), "Title. yes. Content")
    }
    ...
    func test_lightBox_layout() throws {
        ...
        let transformer = PlacementTransformer(placement: (placementResponse?.placements[0])!, pageInstanceGuid: "", startDate: Date())
        let placementViewData = try transformer.transformPlacement()
        XCTAssert(placementViewData.offers.count > 0)
    }
