...
class OfferViewModel {
    ...
    // creative impression event
    internal func sendImpressionEvent(_ creativeInstanceGuid: String?, creativeJWTToken: String) {
    ...
    // creative viewed
    internal func sendViewedEvent(_ creativeInstanceGuid: String?, creativeJWTToken: String) {
        if let creativeInstanceGuid = creativeInstanceGuid {
            RoktAPIHelper.sendEvent(evenRequest:
                                        EventRequest(sessionId: sessionId,
