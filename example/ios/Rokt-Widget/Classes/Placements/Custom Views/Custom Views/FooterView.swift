...
class FooterView {
    ...
    internal class func createView(_ footerElements: FooterElements,
        ...
        if let backgroundColor = footerElements.footerViewData.backgroundColor {
            footerElements.footerContainer.backgroundColor = UIColor(
                colorMap: backgroundColor, footerElements.footerContainer.traitCollection)
        }
        ...
        NSLayoutConstraint.activate([
            ...
            partnerPrivacy.bottomAnchor.constraint(equalTo: stackView.bottomAnchor),
    ...
    private class func getStackViewAlignment(alignment: Alignment) -> UIStackView.Alignment {
        switch alignment {
        case .start:
            return .leading
        case .center:
    ...
    private class func resizeFooter(_ footerElements: FooterElements,
        ...
        if footerElements.footerViewData.roktPrivacyPolicy == nil &&
            ...
            if footerElements.footerViewData.partnerPrivacyPolicy != nil &&
                ...
                footerElements.footerHeight.constant = ((roktPrivacyButton.titleLabel?.frame.size.height ?? 0)
                                                        + (partnerPrivacyButton.titleLabel?.frame.size.height ?? 0)
                                                        + footerPadding)
