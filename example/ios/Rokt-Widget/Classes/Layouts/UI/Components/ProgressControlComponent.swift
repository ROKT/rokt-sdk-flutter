//
//  ProgressControlComponent.swift
//  Rokt-Widget
//
...
struct ProgressControlComponent: View {
    ...
    var style: ProgressControlStyle? {
        switch styleState {
        case .hovered :
    ...
    let model: ProgressControlUIModel
    ...
    private func handleProgressControlAction() {
        if model.direction == .backward {
            baseDI.actionCollection[.previousGroup](nil)
        } else {
            baseDI.actionCollection[.nextGroup](nil)
        }
    }
