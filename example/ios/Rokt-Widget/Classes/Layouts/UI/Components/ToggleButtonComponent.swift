...
struct ToggleButtonComponent: View {
    ...
    private func handleToggle() {
        baseDI.actionCollection[.toggleCustomState](CustomStateIdentifiable(position: config.position, key: model.customStateKey))
    }
