...
internal class RoktAPIHelper {
    ...
    ///   - success: Function to execute after a successfull call to the API. Returns timeout, delay, session timeout and fonts
    ...
    class func getExperienceData(viewName: String?,
        ...
        let sanitisedAttributes = removeAllPrivacyControlData(attributes: attributes)
